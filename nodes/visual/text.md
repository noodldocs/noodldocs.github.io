...
**Align X**  
How to align the node in relation to its parent. Can be **Left**, **Right** or **Center**.

**Align Y**  
How to align the node in relation to its parent. Can be **Top**, **Bottom**, or **Center**.
...
- _Explicit height, Content Width_ - The text node will have the same width as the text string on screen. The height is explicitly set
- _Explicit width, Content Height_ - The text node will have the same height as the text string on screen. The width is explicitly set
