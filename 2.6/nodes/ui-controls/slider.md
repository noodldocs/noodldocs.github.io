...
The Property Panel features editing popouts for the Slider Thumb and Track. These are styled separately using modified versions of the [Dimensions](../shared-props/inputs/visual-input-properties/#dimensions), [Border Style](../shared-props/inputs/visual-input-properties/#border-style), [Corner Radius](../shared-props/inputs/visual-input-properties/#corner-radius) and [Box Shadow](../shared-props/inputs/visual-input-properties/#box-shadow) gadgets.
