...
The incoming items should be an [Array](/nodes/data/array/array.md) of [Objects](/nodes/data/object/object.md), for example coming from a [Static Array](/nodes/data/array/static-array) or [Static Array](/nodes/data/cloud-data/query-records) node.
